...
class TestBinaryOperatorEqualsExpression(unittest.TestCase):
    def setUp(self):
    ...
    def test_eq_max_false(self):
        self._mock_syntax[0].get_probability_distribution.return_value = ProbabilityDistribution({-2: 1, 0: 2, 4: 1})
        self._mock_syntax[1].get_probability_distribution.return_value = ProbabilityDistribution(
            {-3: 2, 1: 1, 3: 2, 5: 1}
        )
    ...
    def test_eq_min_true(self):
        self._mock_syntax[0].get_probability_distribution.return_value = ProbabilityDistribution({4: 1})
