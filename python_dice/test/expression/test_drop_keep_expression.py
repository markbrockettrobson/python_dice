...
class TestDiceExpression(unittest.TestCase):
    def setUp(self):
        self._test_dice_drop = DropKeepExpression("4d6d2")
        self._test_dice_keep = DropKeepExpression("4d6k2")
        self._mock_parser_gen = mock.create_autospec(rply.ParserGenerator)

    def test_drop_keep_add_production_function(self):
        DropKeepExpression.add_production_function(self._mock_parser_gen)
        self._mock_parser_gen.production.assert_called_once_with("""expression : DROP_KEEP_DICE""")

    def test_drop_keep_roll_keep(self):
        test_dice = DropKeepExpression("5d10k2")
        roll_set_drop = set()
    ...
    def test_drop_keep_roll_drop(self):
        test_dice = DropKeepExpression("5d10d3")
        roll_set_keep = set()
        for _ in range(10000):
    ...
    def test_drop_keep_roll_keep_percentile_dice(self):
        test_dice = DropKeepExpression("2d%k1")
        roll_set_keep = set()
    ...
    def test_drop_keep_roll_drop_percentile_dice(self):
        test_dice = DropKeepExpression("2d%d1")
        roll_set_keep = set()
        for _ in range(100000):
            roll_set_keep.add(test_dice.roll())
        self.assertEqual(1, min(roll_set_keep))
    ...
    def test_drop_keep_roll_keep_fate_dice(self):
        test_dice = DropKeepExpression("3dFk2")
        roll_set_keep = set()
        for _ in range(1000):
            roll_set_keep.add(test_dice.roll())
    ...
    def test_drop_keep_roll_drop_fate_dice(self):
        test_dice = DropKeepExpression("3dFd1")
        roll_set_keep = set()
        for _ in range(1000):
            roll_set_keep.add(test_dice.roll())
        self.assertSetEqual({-2, -1, 0, 1, 2}, roll_set_keep)
    ...
    def test_drop_keep_roll_keep_custom_dice(self):
        test_dice = DropKeepExpression("3d[5,10,15]k2")
        roll_set_keep = set()
        for _ in range(1000):
            roll_set_keep.add(test_dice.roll())
    ...
    def test_drop_keep_roll_drop_custom_dice(self):
        test_dice = DropKeepExpression("3d[-3,2,4]d1")
        roll_set_keep = set()
        for _ in range(1000):
            roll_set_keep.add(test_dice.roll())
    ...
    def test_drop_keep_roll_keep_to_many(self):
        test_dice = DropKeepExpression("2d3k10")
        roll_set_keep = set()
        for _ in range(10000):
            roll_set_keep.add(test_dice.roll())
        self.assertEqual(2, min(roll_set_keep))
    ...
    def test_drop_keep_roll_drop_to_many(self):
        test_dice = DropKeepExpression("2d3d10")
        roll_set_keep = set()
        for _ in range(10000):
            roll_set_keep.add(test_dice.roll())
    ...
    def test_drop_keep_roll_keep_to_zero(self):
        test_dice = DropKeepExpression("2d3k0")
        roll_set_keep = set()
        for _ in range(10000):
            roll_set_keep.add(test_dice.roll())
        self.assertEqual(0, min(roll_set_keep))
    ...
    def test_drop_keep_roll_drop_to_zero(self):
        test_dice = DropKeepExpression("2d3d0")
        roll_set_keep = set()
        for _ in range(10000):
            roll_set_keep.add(test_dice.roll())
        self.assertEqual(2, min(roll_set_keep))
    ...
    def test_drop_keep_min_keep_percentile_dice(self):
        test_dice = DropKeepExpression("14d%k12")
    ...
    def test_drop_keep_estimated_cost_missing_dice_amount(self):
        self._test_dice_drop = DropKeepExpression("d6d2")
        self._test_dice_keep = DropKeepExpression("d6k2")
    ...
    def test_drop_keep_estimated_cost_percentile_dice(self):
        self._test_dice_drop = DropKeepExpression("4d%d2")
        self._test_dice_keep = DropKeepExpression("4d%k2")
    ...
    def test_drop_keep_estimated_cost_fate_dice(self):
        self._test_dice_drop = DropKeepExpression("4dFd2")
        self._test_dice_keep = DropKeepExpression("4dFk2")
    ...
    def test_drop_keep_estimated_custom_dice_negative(self):
        self._test_dice_drop = DropKeepExpression("4d[-2,2,100]d2")
        self._test_dice_keep = DropKeepExpression("4d[-2,2,100]k2")
        self.assertEqual(24, self._test_dice_drop.estimated_cost())
        self.assertEqual(24, self._test_dice_keep.estimated_cost())

    def test_drop_keep_estimated_custom_dice_large_set(self):
        self._test_dice_drop = DropKeepExpression("4d[-2,0,2,4,6*7,31,-2,-24]d2")
        self._test_dice_keep = DropKeepExpression("4d[-2,0,2,4,6*7,31,-2,-24]k2")
    ...
    def test_drop_keep_get_probability_distribution_drop(self):
        test_dice = DropKeepExpression("6d4d4")
        self.assertEqual(
    ...
    def test_drop_keep_get_probability_distribution_drop_large_dice(self):
        test_dice = DropKeepExpression("6d8d4")
        self.assertEqual(
            {
                2: 43653,
                3: 54186,
    ...
    def test_drop_keep_get_probability_distribution_drop_large_number_dice(self):
        test_dice = DropKeepExpression("20d3d16")
        self.assertEqual(
            {
                4: 3276020625,
                5: 149420940,
    ...
    def test_drop_keep_get_probability_distribution_keep(self):
        test_dice = DropKeepExpression("6d4k2")
        self.assertEqual(
    ...
    def test_drop_keep_get_probability_distribution_keep_large_dice(self):
        test_dice = DropKeepExpression("6d8k2")
        self.assertEqual(
            {
                2: 1,
                3: 6,
    ...
    def test_drop_keep_get_probability_distribution_keep_large_number_dice(self):
        test_dice = DropKeepExpression("20d3k4")
        self.assertEqual(
            {
                4: 1,
                5: 20,
    ...
    def test_drop_keep_get_probability_distribution_range(self):
        test_dice = DropKeepExpression("3d[-1-1, 0]d1")
        self.assertEqual(
