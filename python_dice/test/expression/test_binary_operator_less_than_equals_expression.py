...
class TestBinaryOperatorLessThanEqualsExpression(unittest.TestCase):
    def setUp(self):
    ...
    def test_le_max_false(self):
        self._mock_syntax[0].get_probability_distribution.return_value = ProbabilityDistribution({6: 1})
    ...
    def test_le_min_true(self):
        self._mock_syntax[0].get_probability_distribution.return_value = ProbabilityDistribution({3: 1})
