...
class TestBinaryOperatorNotExpression(unittest.TestCase):
    def setUp(self):
        ...
        self._mock_syntax.get_probability_distribution.return_value = ProbabilityDistribution({-3: 1, 0: 2, 4: 1})
    ...
    def test_binary_operator_add_production_function(self):
        NotExpression.add_production_function(self._mock_parser_gen)
    ...
    def test_ne_max_false(self):
        self._mock_syntax.get_probability_distribution.return_value = ProbabilityDistribution({4: 1, 54: 1})
        self.assertEqual(0, self._test_binary_operator.max())

    def test_ne_min_true(self):
        self._mock_syntax.get_probability_distribution.return_value = ProbabilityDistribution({0: 1})
