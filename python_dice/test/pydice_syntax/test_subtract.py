...
class TestSubtract(unittest.TestCase):
    def setUp(self):
        ...
        self._test_add = subtract.Subtract(self._mock_syntax[0], self._mock_syntax[1])
    ...
    def test_subtract_get_token_name(self):
        self.assertEqual("SUBTRACT", self._test_add.get_token_name())
    ...
    def test_subtract_roll(self):
        for _ in range(100):
            self.assertEqual(6, self._test_add.roll())

    def test_subtract_max(self):
        self.assertEqual(2, self._test_add.max())

    def test_subtract_min(self):
        self.assertEqual(-2, self._test_add.min())
