...
class TestConstraintSetFactory(unittest.TestCase):
    ...
    def test_uses_constraint_merger():
        mock_constraint_merger = mock.create_autospec(IConstraintMerger)
    ...
    def test_uses_constraint_factory(self):
        mock_constraint_factory = mock.create_autospec(IConstraintFactory)
