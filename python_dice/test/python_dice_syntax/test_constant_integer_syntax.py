...
class TestConstantIntegerSyntax(unittest.TestCase):
    def test_constant_integers_get_token_name(self):
        self.assertEqual(
            "CONSTANT_INTEGER",
            constant_integer_syntax.ConstantIntegerSyntax.get_token_name(),
        )

    def test_constant_integers_get_token_regex(self):
        self.assertEqual(
            r"-?\d+", constant_integer_syntax.ConstantIntegerSyntax.get_token_regex()
        )
    ...
    def test_constant_integer_regex_will_match(self):
        ...
        for test_case in test_cases:
            self.assertTrue(
                re.match(
                    constant_integer_syntax.ConstantIntegerSyntax.get_token_regex(),
                    test_case,
                ),
